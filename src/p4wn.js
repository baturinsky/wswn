...
export var P4_MOVE_FLAG_OK = 1;
export var P4_MOVE_FLAG_CHECK = 2;
export var P4_MOVE_FLAG_MATE = 4;
export var P4_MOVE_FLAG_CAPTURE = 8;
export var P4_MOVE_FLAG_CASTLE_KING = 16;
export var P4_MOVE_FLAG_CASTLE_QUEEN = 32;
export var P4_MOVE_FLAG_DRAW = 64;

export var P4_MOVE_ILLEGAL = 0;
export var P4_MOVE_MISSED_MATE = P4_MOVE_FLAG_CHECK | P4_MOVE_FLAG_MATE;
export var P4_MOVE_CHECKMATE =
  P4_MOVE_FLAG_OK | P4_MOVE_FLAG_CHECK | P4_MOVE_FLAG_MATE;
export var P4_MOVE_STALEMATE = P4_MOVE_FLAG_OK | P4_MOVE_FLAG_MATE;
...
export function p4_move2string(state, s, e, S, promotion, flags, moves) {
  var piece = S & 14;
  var src, dest;
  var mv, i;
...
export function p4_jump_to_moveno(state, moveno) {
 ...
 * */
export function p4_state2fen(state, reduced) {
...
export function p4_stringify_point(p) {
...
export function p4_destringify_point(p) {
...
export function p4_interpret_movestring(state, str) {
...
export function p4_find_source_point(state, e, str) {
  var colour = state.to_play;
 ...
 */
export function p4_random_seed(state, seed) {
  seed &= 0xffffffff;
...
export function p4_random31(state) {
  var rng = state.rng;
  var b = rng[1];
  var c = rng[2];
...
export function p4_random_int(state, top) {
